...
const Couriers: React.FC = () => {
  ...
  const EarningButton = (
    <TranparentButton text={t("learn_more_btn")} link={"restaurantInfo"} />
  );
  const FLexiblegButton = (
    <TranparentButton text={t("learn_more_btn")} link={"rider"} />
  );
  const EarnWhereButton = (
    <TranparentButton text={t("get_started_btn")} link={"rider"} />
  );
  return (
